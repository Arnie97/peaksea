...
if &background=='light'
  ...
  if &t_Co==256
    ...
    hi DiffAdd		ctermfg=NONE	ctermbg=150	cterm=NONE
    hi DiffChange	ctermfg=NONE	ctermbg=152	cterm=NONE
    hi DiffDelete	ctermfg=NONE	ctermbg=174	cterm=NONE
    hi DiffText		ctermfg=NONE	ctermbg=187	cterm=NONE
...
elseif &background=='dark'
  ...
  elseif &t_Co==256
    ...
    hi DiffText		ctermfg=NONE	ctermbg=94	cterm=NONE
